...
region = 'us-east-1'
queue =  "https://sqs.us-east-1.amazonaws.com/592189492427/Genezip server"
S3_in = "input bucket"
...
while True:
    ...
    if "Messages" in response :
        ...
        cmd = "SPILCE-q.py -b " + body + " -g annotation.gtf -o outfile.tsv"
        shellCommand = os.system(["SPLICE-q.py", "-b", body, "-g", "annotation.gtf", "-o", "outfile.tsv"])

        s3_client.upload_file("outfile.tsv",S3_out, str(uuid.uuid1())+"_"+body)
